            ...
            <div class="navbar-collapse navbar-collapse-1">
                <div class="container">
                    <ul class="nav navbar-nav navbar-utility">
                        ...
                        <#if referrer?has_content && referrer.url?has_content><li><a href="${referrer.url}" id="referrer">${msg("backTo",referrer.name)}</a></li>
                        <#else>
                            <a id="referrer">${msg("backTo")}</a>
                            <script>
                                document.getElementById('referrer').href = "https://" + (window.location.host.startsWith("dev.") ? "dev." : "") + "lahendus.ut.ee";
                            </script>
                        </#if>
